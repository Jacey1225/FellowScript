...
import EncodedTransformWorkerManager, { EncodedTransformWorkerManagerObserver } from '../encodedtransformmanager/EncodedTransformWorkerManager';
...
import MeetingSessionTiming, { MeetingSessionTimingObserver } from '../meetingsessiontiming/MeetingSessionTiming';
...
export default class DefaultAudioVideoController implements AudioVideoController, SimulcastUplinkObserver, MediaStreamBrokerObserver, EncodedTransformWorkerManagerObserver, EncodedTransformMediaMetricsObserver, MeetingSessionTimingObserver, Destroyable {
    private _logger;
    ...
    private _encodedTransformWorkerManager;
    private _meetingSessionTimingManager;
    private _timingResolutionObserver;
    ...
    destroyed: boolean;
    constructor(configuration: MeetingSessionConfiguration, logger: Logger, webSocketAdapter: WebSocketAdapter, mediaStreamBroker: MediaStreamBroker, reconnectController: ReconnectController, eventController?: EventController, encodedTransformWorkerManager?: EncodedTransformWorkerManager);
    ...
    onFirstPacketReceived(mediaType: 'audio' | 'video', direction: 'send' | 'receive', ssrc: number): void;
