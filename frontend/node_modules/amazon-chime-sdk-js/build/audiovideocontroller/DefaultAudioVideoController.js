...
const AudioVideoEventAttributes_1 = require("../eventcontroller/AudioVideoEventAttributes");
...
const MeetingSessionTimingManager_1 = __importDefault(require("../meetingsessiontiming/MeetingSessionTimingManager"));
...
const StartEncodedTransformWorkerTask_1 = __importDefault(require("../task/StartEncodedTransformWorkerTask"));
...
class DefaultAudioVideoController {
    constructor(configuration, logger, webSocketAdapter, mediaStreamBroker, reconnectController, eventController, encodedTransformWorkerManager) {
        ...
        this._meetingSessionTimingManager = new MeetingSessionTimingManager_1.default(logger);
    ...
    async destroy() {
        ...
        (_a = this._encodedTransformWorkerManager) === null || _a === void 0 ? void 0 : _a.removeObserver(this);
        this.destroyed = true;
    }
    get configuration() {
    ...
    initSignalingClient() {
        ...
        (_a = this._encodedTransformWorkerManager) === null || _a === void 0 ? void 0 : _a.addObserver(this);
        this.meetingSessionContext.meetingSessionConfiguration = this.configuration;
        this.meetingSessionContext.signalingClient = new DefaultSignalingClient_1.default(this._webSocketAdapter, this.logger, this._meetingSessionTimingManager);
    ...
    connectWithPromises(needsToWaitForAttendeePresence) {
        ...
        const startEncodedTransformWorker = new StartEncodedTransformWorkerTask_1.default(context).once();
        ...
        // Third layer.
        const createPeerConnection = new CreatePeerConnectionTask_1.default(context).once(signaling, startEncodedTransformWorker);
    ...
    async actionConnect(reconnecting) {
        var _a;
        ...
        if (!useAudioConnection) {
            ...
            this.meetingSessionContext.transceiverController = new VideoOnlyTransceiverController_1.default(this.logger, this.meetingSessionContext.browserBehavior, this.meetingSessionContext, this._encodedTransformWorkerManager);
        }
            ...
            if (new DefaultModality_1.default(this.configuration.credentials.attendeeId).hasModality(DefaultModality_1.default.MODALITY_CONTENT)) {
                this.meetingSessionContext.transceiverController =
                    new SimulcastContentShareTransceiverController_1.default(this.logger, this.meetingSessionContext.browserBehavior, this.meetingSessionContext, this._encodedTransformWorkerManager);
            }
            else {
                this.meetingSessionContext.transceiverController = new SimulcastTransceiverController_1.default(this.logger, this.meetingSessionContext.browserBehavior, this.meetingSessionContext, this._encodedTransformWorkerManager);
            }
        }
        else {
            this.logger.info(`Using default transceiver controller`);
            this.meetingSessionContext.transceiverController = new DefaultTransceiverController_1.default(this.logger, this.meetingSessionContext.browserBehavior, this.meetingSessionContext, this._encodedTransformWorkerManager);
        }
        ...
        if (this.enableSimulcast) {
            ...
            if (!this.meetingSessionContext.videoUplinkBandwidthPolicy) {
                this.meetingSessionContext.videoUplinkBandwidthPolicy =
                    new NScaleVideoUplinkBandwidthPolicy_1.default(this.configuration.credentials.attendeeId, !this.meetingSessionContext.browserBehavior.disableResolutionScaleDown(), this.meetingSessionContext.logger, this.meetingSessionContext.browserBehavior);
        ...
        if (!this.meetingSessionContext.videoDownlinkBandwidthPolicy) {
            this.meetingSessionContext.videoDownlinkBandwidthPolicy =
                this.enableSVC || this.enableSimulcast
                    ? new VideoPriorityBasedPolicy_1.default(this.meetingSessionContext.logger)
                    : new AllHighestVideoBandwidthPolicy_1.default(this.configuration.credentials.attendeeId);
        }
        if (new DefaultModality_1.default(this.configuration.credentials.attendeeId).hasModality(DefaultModality_1.default.MODALITY_CONTENT)) {
        ...
        this.meetingSessionContext.videoCaptureAndEncodeParameter =
            new DefaultVideoCaptureAndEncodeParameter_1.default(0, 0, 0, 0, false);
        ...
        try {
            ...
            this.sessionStateController.perform(SessionStateControllerAction_1.default.FinishConnecting, () => {
                ...
                /* istanbul ignore else */
                (_a = this.eventController) === null || _a === void 0 ? void 0 : _a.publishEvent('meetingStartSucceeded', (0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.meetingSessionContext));
            ...
            this.sessionStateController.perform(SessionStateControllerAction_1.default.Fail, async () => {
    ...
    async actionDisconnect(status, reconnecting, error) {
        var _a;
        try {
            await new SerialGroupTask_1.default(this.logger, this.wrapTaskName('AudioVideoStop'), [
        ...
        try {
            ...
            this.cleanUpMediaStreamsAfterStop();
            await new SerialGroupTask_1.default(this.logger, this.wrapTaskName('AudioVideoClean'), subtasks).run();
        }
        catch (cleanError) {
            /* istanbul ignore next */
            this.logger.info('fail to clean');
        }
        await ((_a = this._encodedTransformWorkerManager) === null || _a === void 0 ? void 0 : _a.stop());
    ...
    updateRemoteVideosFromPolicy() {
        if (this.meetingSessionContext.videoDownlinkBandwidthPolicy &&
            ...
            this.meetingSessionContext.videoDownlinkBandwidthPolicy.getServerSideNetworkAdaption !==
                undefined &&
            !(0, ServerSideNetworkAdaption_1.serverSideNetworkAdaptionIsNoneOrDefault)(this.meetingSessionContext.videoDownlinkBandwidthPolicy.getServerSideNetworkAdaption())) {
    ...
    sendRemoteVideoUpdate() {
        ...
        const currentConfigs = (0, VideoPreferences_1.convertVideoPreferencesToSignalingClientVideoSubscriptionConfiguration)(context, groupIdsToReceive, context.videoDownlinkBandwidthPolicy.getVideoPreferences());
    ...
    async replaceLocalVideo(videoStream) {
        ...
        await this.meetingSessionContext.transceiverController.setVideoInput(videoStream.getVideoTracks()[0]);
    ...
    async replaceLocalAudio(audioStream) {
        ...
        this.connectionHealthData.reset();
        this.connectionHealthData.setConnectionStartTime();
        const replaceTrackSuccess = await this.meetingSessionContext.transceiverController.replaceAudioTrack(audioStream.getAudioTracks()[0]);
    ...
    async actionUpdateWithRenegotiation(notify) {
        ...
        try {
            await new SerialGroupTask_1.default(this.logger, this.wrapTaskName('AudioVideoUpdate'), [
    ...
    notifyStop(status, error) {
        ...
        if (this.eventController) {
            const attributes = {
                ...(0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.meetingSessionContext),
    ...
    reconnect(status, error) {
        ...
        const willRetry = this._reconnectController.retryWithBackoff(async () => {
            if (this.sessionStateController.state() === SessionStateControllerState_1.default.NotConnected) {
                this.sessionStateController.perform(SessionStateControllerAction_1.default.Connect, () => {
    ...
    async actionReconnect(status) {
        ...
        try {
            await new SerialGroupTask_1.default(this.logger, this.wrapTaskName('AudioVideoReconnect'), [
            ...
            this.sessionStateController.perform(SessionStateControllerAction_1.default.FinishConnecting, () => {
                var _a;
                /* istanbul ignore else */
                (_a = this.eventController) === null || _a === void 0 ? void 0 : _a.publishEvent('meetingReconnected', {
                    ...(0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.meetingSessionContext),
                    meetingStatus: MeetingSessionStatusCode_1.default[status.statusCode()],
                });
                this.actionFinishConnecting();
    ...
    async enforceBandwidthLimitationForSender(maxBitrateKbps) {
        await this.meetingSessionContext.transceiverController.setVideoSendingBitrateKbps(maxBitrateKbps);
    }
    ...
    async handleHasBandwidthPriority(hasBandwidthPriority) {
    ...
    async actionPromoteToPrimaryMeeting(credentials) {
        let resultingStatus = new MeetingSessionStatus_1.default(MeetingSessionStatusCode_1.default.SignalingRequestFailed);
        await new SerialGroupTask_1.default(this.logger, this.wrapTaskName('PromoteToPrimaryMeeting'), [
    ...
    async videoInputDidChange(videoStream) {
    ...
    async audioInputDidChange(audioStream) {
     ...
     */
    onEncodedTransformWorkerManagerFailed(error) {
        this.logger.error(`Encoded transform worker failed: ${error.message}`);
        if (this.sessionStateController.state() !== SessionStateControllerState_1.default.Connected) {
        ...
        const status = new MeetingSessionStatus_1.default(MeetingSessionStatusCode_1.default.EncodedTransformManagerFailed);
        this.reconnect(status, error);
    }
    // Routes first-packet events from the encoded transform layer into the timing manager.
    onFirstPacketReceived(mediaType, direction, ssrc) {
        var _a, _b;
        if (mediaType === 'audio') {
            ...
            if (direction === 'receive') {
                /* istanbul ignore next */
                const streamId = (_a = this.meetingSessionContext.videoStreamIndex) === null || _a === void 0 ? void 0 : _a.streamIdForSSRC(ssrc);
                if (streamId === undefined) {
                    this.logger.warn(`Received first video packet but no stream ID found for ssrc=${ssrc}`);
                    return;
                }
                /* istanbul ignore next */
                const groupId = (_b = this.meetingSessionContext.videoStreamIndex) === null || _b === void 0 ? void 0 : _b.groupIdForStreamId(streamId);
                if (groupId === undefined) {
                    this.logger.warn(`Received first video packet but no group ID found for streamId=${streamId} ssrc=${ssrc}`);
                    return;
                }
    ...
    onMeetingSessionTimingReady(timing) {
        if (!this.meetingSessionContext.signalingClient) {
