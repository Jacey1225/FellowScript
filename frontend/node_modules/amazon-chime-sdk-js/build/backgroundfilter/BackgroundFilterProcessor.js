...
const BackgroundFilterFrameCounter_1 = __importDefault(require("./BackgroundFilterFrameCounter"));
/** @internal */
...
class BackgroundFilterProcessor {
    ...
    async loadAssets() {
        ...
        try {
            this.worker = await (0, loader_1.loadWorker)(this.spec.paths.worker, 'BackgroundFilterWorker', {}, null);
