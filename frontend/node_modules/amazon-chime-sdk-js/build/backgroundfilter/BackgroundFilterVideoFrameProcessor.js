...
class BackgroundFilterVideoFrameProcessor {
    ...
    scope = globalThis, spec, logger) {
        ...
        try {
            const worker = await (0, loader_1.loadWorker)(workerURL, 'BackgroundFilterWorker', {}, null);
            try {
                worker.terminate();
            }
            catch (e) {
