    ...
    constructor(logger, videoStreamIndex, selfAttendeeId) {
        ...
        this.audioUpstreamMetricMap = {
            ...
            audioSentTransformPps: {
                transform: this.countPerSecond,
                type: SignalingProtocol_js_1.SdkMetric.Type.AUDIO_SENT_TRANSFORM_PPS,
            },
        };
        this.audioDownstreamMetricMap = {
            ...
            audioReceivedTransformPps: {
                transform: this.countPerSecond,
                type: SignalingProtocol_js_1.SdkMetric.Type.AUDIO_RECEIVED_TRANSFORM_PPS,
            },
        };
        this.videoUpstreamMetricMap = {
            ...
            videoSentTransformPps: {
                transform: this.countPerSecond,
                type: SignalingProtocol_js_1.SdkMetric.Type.VIDEO_SENT_TRANSFORM_PPS,
            },
        };
        this.videoDownstreamMetricMap = {
            ...
            videoReceivedTransformPps: {
                transform: this.countPerSecond,
                type: SignalingProtocol_js_1.SdkMetric.Type.VIDEO_RECEIVED_TRANSFORM_PPS,
            },
            videoRemoteRenderFps: {
                transform: this.identityValue,
                type: SignalingProtocol_js_1.SdkMetric.Type.VIDEO_REMOTE_RENDER_FPS,
            },
        };
        /**
