...
class DefaultDeviceController {
    ...
    async startAudioInputTask(device) {
        ...
        try {
            if ((0, AudioTransformDevice_1.isAudioTransformDevice)(device)) {
            ...
            if (this.useWebAudio) {
                ...
                await ((_a = this.transform) === null || _a === void 0 ? void 0 : _a.device.mute(this.muted));
    ...
    async chooseAudioTransformInputDevice(device) {
        var _a;
    ...
    async chooseVideoTransformInputDevice(device) {
        var _a;
    ...
    async startVideoInput(device) {
        return await this.videoInputTaskQueue.add(() => this.startVideoInputTask(device));
    }
    async startVideoInputTask(device) {
        if (!device) {
            this.logger.error('Invalid video input device');
            return undefined;
        }
        try {
            if ((0, VideoTransformDevice_1.isVideoTransformDevice)(device)) {
    ...
    async acquireDisplayInputStream(_streamConstraints) {
    ...
    async listDevicesOfKind(deviceKind, forceUpdate) {
    ...
    async updateDeviceInfoCacheFromBrowser() {
        var _a;
    ...
    async handleDeviceStreamEnded(kind, deviceId) {
        try {
            if (kind === 'audio') {
                if (this.useWebAudio &&
    ...
    async chooseInputIntrinsicDevice(kind, device) {
        var _a, _b;
    ...
    async handleNewInputDevice(kind, newDevice) {
        var _a;
