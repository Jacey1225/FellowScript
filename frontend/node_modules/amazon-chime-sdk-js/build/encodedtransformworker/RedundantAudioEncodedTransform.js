 ...
 */
class RedundantAudioEncodedTransform extends EncodedTransform_1.default {
    constructor() {
        super();
    ...
    transformName() {
        return EncodedTransform_1.TRANSFORM_NAMES.REDUNDANT_AUDIO;
    }
    /**
    ...
    maybeReportLossStats(ssrc, timestamp) {
        ...
        self.postMessage({
            ...
            transformName: EncodedTransform_1.TRANSFORM_NAMES.REDUNDANT_AUDIO,
            message: {
                ssrc: String(ssrc),
...
exports.default = RedundantAudioEncodedTransform;
