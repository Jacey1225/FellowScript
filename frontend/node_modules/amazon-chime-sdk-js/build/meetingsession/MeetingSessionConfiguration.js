...
class MeetingSessionConfiguration {
    ...
    constructor(createMeetingResponse, createAttendeeResponse) {
        ...
        if (createMeetingResponse) {
            createMeetingResponse = (0, Utils_1.toLowerCasePropertyNames)(createMeetingResponse);
        ...
        if (createAttendeeResponse) {
            createAttendeeResponse = (0, Utils_1.toLowerCasePropertyNames)(createAttendeeResponse);
