...
class DefaultMessagingSession {
    ...
    async startConnecting(reconnecting) {
    ...
    async startConnectingInternal(reconnecting) {
        var _a;
        ...
        if (reconnecting || endpointUrl === undefined) {
            try {
                if (this.configuration.chimeClient.getMessagingSessionEndpoint instanceof Function) {
                    ...
                    endpointUrl = (await this.configuration.chimeClient.send(new client_chime_sdk_messaging_1.GetMessagingSessionEndpointCommand({}))).Endpoint.Url;
                }
    ...
    async prepareWebSocketUrl(endpointUrl) {
        ...
        return await this.sigV4.signURL('GET', 'wss', 'chime', endpointUrl, '/connect', '', queryParams);
    }
    isClosed() {
