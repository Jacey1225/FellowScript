...
class DefaultSignalingClient {
    constructor(webSocket, logger, meetingSessionTimingManager) {
        this.webSocket = webSocket;
        this.logger = logger;
        this.meetingSessionTimingManager = meetingSessionTimingManager;
        this.closeEventHandler = (event) => {
            this.resetConnection();
            this.sendEvent(new SignalingClientEvent_1.default(this, SignalingClientEventType_1.default.WebSocketClosed, null, event.code, event.reason, event.wasClean));
    ...
    join(settings) {
        ...
        const browserBehavior = settings.browserBehavior || new DefaultBrowserBehavior_1.default();
        const sdkClientDetails = {
            ...
            clientUtcOffset: (0, Utils_1.getFormattedOffset)(new Date().getTimezoneOffset()),
        };
        const deviceModel = (_a = browserBehavior.deviceName) === null || _a === void 0 ? void 0 : _a.call(browserBehavior);
        const osName = (_b = browserBehavior.osName) === null || _b === void 0 ? void 0 : _b.call(browserBehavior);
        const osVersion = (_c = browserBehavior.osVersion) === null || _c === void 0 ? void 0 : _c.call(browserBehavior);
        if (deviceModel)
            sdkClientDetails.deviceModel = deviceModel;
        if (osName)
            sdkClientDetails.osName = osName;
        if (osVersion)
            sdkClientDetails.osVersion = osVersion;
        ...
        joinFrame.serverSideNetworkAdaption = (0, ServerSideNetworkAdaption_1.convertServerSideNetworkAdaptionEnumToSignaled)(settings.serverSideNetworkAdaption);
        joinFrame.supportedServerSideNetworkAdaptions =
            settings.supportedServerSideNetworkAdaptions.map(ServerSideNetworkAdaption_1.convertServerSideNetworkAdaptionEnumToSignaled);
        ...
        this.sendMessage(message);
        (_d = this.meetingSessionTimingManager) === null || _d === void 0 ? void 0 : _d.onJoinSent();
    }
    subscribe(settings) {
        var _a;
        ...
        this.sendMessage(message);
        (_a = this.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onSubscribeSent();
    }
    ...
    setUpEventListeners() {
        this.webSocket.addEventListener('open', () => {
            ...
            (_a = this.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onTransportConnected();
        });
    ...
    generateNewAudioSessionId() {
        ...
        (0, Utils_1.getRandomValues)(num);
        return num[0];
    }
    sendMeetingSessionTiming(timing) {
        const timingFrame = SignalingProtocol_js_1.SdkMeetingSessionTimingFrame.create();
        timingFrame.signaling = timing.signaling.map(s => {
            return SignalingProtocol_js_1.SdkMeetingSessionSignalingTiming.create({
                startMs: s.startMs,
        ...
        timingFrame.remoteAudio = timing.remoteAudio.map(ra => {
            return SignalingProtocol_js_1.SdkMeetingSessionRemoteAudioTiming.create({
                addedMs: ra.addedMs,
        ...
        timingFrame.localAudio = timing.localAudio.map(la => {
            return SignalingProtocol_js_1.SdkMeetingSessionLocalAudioTiming.create({
                addedMs: la.addedMs,
        ...
        timingFrame.localVideo = timing.localVideo.map(lv => {
            return SignalingProtocol_js_1.SdkMeetingSessionLocalVideoTiming.create({
                addedMs: lv.addedMs,
        ...
        timingFrame.remoteVideos = timing.remoteVideos.map(rv => {
            return SignalingProtocol_js_1.SdkMeetingSessionRemoteVideoTiming.create({
                groupId: rv.groupId,
                addedMs: rv.addedMs,
        ...
        const message = SignalingProtocol_js_1.SdkSignalFrame.create();
        message.type = SignalingProtocol_js_1.SdkSignalFrame.Type.MEETING_SESSION_TIMING;
