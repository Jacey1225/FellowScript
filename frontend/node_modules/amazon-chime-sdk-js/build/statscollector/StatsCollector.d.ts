...
import { EncodedTransformMediaMetrics, EncodedTransformMediaMetricsObserver } from '../encodedtransformmanager/MediaMetricsEncodedTransformManager';
/**
 * [[StatsCollector]] gathers statistics and sends metrics.
 */
export default class StatsCollector implements RedundantAudioRecoveryMetricsObserver, VideoTileResolutionObserver, EncodedTransformMediaMetricsObserver {
    ...
    private remoteRenderFpsMap;
    private encodedTransformMediaMetrics;
    private encodedTransformMediaMetricsTimestamp;
     ...
     */
    private maybeAddTransformMetrics;
    /**
