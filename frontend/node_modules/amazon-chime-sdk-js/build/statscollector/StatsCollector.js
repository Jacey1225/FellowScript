...
class StatsCollector {
    constructor(audioVideoController, logger, interval = StatsCollector.INTERVAL_MS) {
        ...
        this.remoteRenderFpsMap = new Map();
        this.encodedTransformMediaMetrics = null;
        this.encodedTransformMediaMetricsTimestamp = 0;
    ...
    videoTileUnbound(attendeeId, groupId) {
        this.resolutionMap.delete(attendeeId);
        if (groupId !== undefined) {
            this.remoteRenderFpsMap.delete(groupId);
        }
    }
    videoTileRenderMetricsDidReceive(groupId, metrics) {
        if (groupId === 0) {
            return;
        }
     ...
     */
    encodedTransformMediaMetricsDidReceive(metrics) {
     ...
     */
    maybeAddTransformMetrics(customStatsReports) {
