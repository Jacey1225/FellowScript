...
class CreatePeerConnectionTask extends BaseTask_1.default {
    ...
    addPeerConnectionEventLogger() {
        ...
        peer.addEventListener('iceconnectionstatechange', () => {
            ...
            if (peer.iceConnectionState === 'connected') {
                ...
                (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onIceConnected();
            }
        });
    }
    async run() {
    ...
    addRemoteVideoTrack(track, stream) {
        ...
        tile.bindVideoStream(attendeeId, false, stream, width, height, streamId, externalUserId, groupId);
        this.logger.info(`video track added, use tile=${tile.id()} track=${trackId} streamId=${streamId} groupId=${groupId}`);
    ...
    removeRemoteVideoTrack(track, tileState) {
        ...
        if (tileState.groupId !== null) {
            /* istanbul ignore next */
            (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onRemoteVideoRemoved(tileState.groupId);
        }
