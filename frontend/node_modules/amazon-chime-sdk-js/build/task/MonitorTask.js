...
class MonitorTask extends BaseTask_1.default {
    constructor(context, connectionHealthPolicyConfiguration, initialConnectionHealthData) {
        ...
        this.reconnectionHealthPolicy = new ReconnectionHealthPolicy_1.default(context.logger, { ...connectionHealthPolicyConfiguration }, this.initialConnectionHealthData.clone());
        this.unusableAudioWarningHealthPolicy = new UnusableAudioWarningConnectionHealthPolicy_1.default({ ...connectionHealthPolicyConfiguration }, this.initialConnectionHealthData.clone());
        this.sendingAudioFailureHealthPolicy = new SendingAudioFailureConnectionHealthPolicy_1.default(context.logger, { ...connectionHealthPolicyConfiguration }, this.initialConnectionHealthData.clone());
        for (const policy of connectionHealthPolicyConfiguration.videoEncodingHealthPolicies) {
            this.videoEncodingHealthPolicies.push(new policy({ ...connectionHealthPolicyConfiguration }, this.initialConnectionHealthData.clone()));
        }
    }
    removeObserver() {
    ...
    connectionHealthDidChange(connectionHealthData) {
        ...
        this.applyHealthPolicy(this.unusableAudioWarningHealthPolicy, connectionHealthData, () => {
            ...
            (_a = this.context.eventController) === null || _a === void 0 ? void 0 : _a.publishEvent('receivingAudioDropped', (0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.context));
        ...
        if (this.context.isSessionConnected) {
            const publishFilteredEvent = (event) => {
                var _a;
                const attributes = (0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.context);
                (_a = this.context.eventController) === null || _a === void 0 ? void 0 : _a.publishEvent(event, attributes);
            };
            this.applyHealthPolicy(this.sendingAudioFailureHealthPolicy, connectionHealthData, () => publishFilteredEvent('sendingAudioFailed'), () => publishFilteredEvent('sendingAudioRecovered'));
        }
    }
    ...
    handleSignalingClientEvent(event) {
        ...
        if ((event.type === SignalingClientEventType_1.default.WebSocketClosed &&
            ...
            if (!this.hasSignalingError) {
                (_a = this.context.eventController) === null || _a === void 0 ? void 0 : _a.publishEvent('signalingDropped', {
                    ...(0, AudioVideoEventAttributes_1.audioVideoEventAttributesFromState)(this.context),
    ...
    isUnexpectedsignalingCloseCode(closeCode) {
        return (
     ...
     */
    degradeVideoEncoding(cause) {
        var _a;
        if (((_a = this.context.videoUplinkBandwidthPolicy) === null || _a === void 0 ? void 0 : _a.degradeScalabilityMode) &&
