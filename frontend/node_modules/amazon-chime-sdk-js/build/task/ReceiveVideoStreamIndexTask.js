...
class ReceiveVideoStreamIndexTask extends BaseTask_1.default {
    ...
    resubscribe(videoDownlinkBandwidthPolicy, videoUplinkBandwidthPolicy) {
        ...
        if (resubscribeForDownlink && !this.context.videosToReceive.empty()) {
            this.context.videosToReceive.forEach((streamId) => {
                var _a;
                const groupId = this.context.videoStreamIndex.groupIdForStreamId(streamId);
                if (groupId !== undefined) {
                    (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onRemoteVideoAdded(groupId);
                }
            });
        }
        else {
            (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.clearExpectingRemoteVideo();
        }
        (_b = this.context.meetingSessionTimingManager) === null || _b === void 0 ? void 0 : _b.onResubscribeStart();
