...
class SetLocalDescriptionTask extends BaseTask_1.default {
    ...
    async run() {
        ...
        const skipHeaderExtensionMunging = DefaultTransceiverController_1.default.canUseHeaderExtensionApi(peer);
        if (!skipHeaderExtensionMunging &&
            ...
            sdp = new SDP_1.default(sdp).withVideoLayersAllocationRtpHeaderExtension(this.context.previousSdpOffer).sdp;
        }
        ...
        if (!skipHeaderExtensionMunging &&
            ...
            this.context.videoUplinkBandwidthPolicy.wantsVideoDependencyDescriptorRtpHeaderExtension !==
                undefined &&
            this.context.videoUplinkBandwidthPolicy.wantsVideoDependencyDescriptorRtpHeaderExtension()) {
            sdp = new SDP_1.default(sdp).withDependencyDescriptorRtpHeaderExtension(this.context.previousSdpOffer).sdp;
        }
        ...
        await new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onSetLocalDescription();
                resolve();
            }
            catch (error) {
                reject(error);
