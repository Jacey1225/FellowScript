...
class SubscribeAndReceiveSubscribeAckTask extends BaseTask_1.default {
    ...
    async run() {
        ...
        if (this.context.videoDownlinkBandwidthPolicy.getServerSideNetworkAdaption !== undefined &&
            !(0, ServerSideNetworkAdaption_1.serverSideNetworkAdaptionIsNoneOrDefault)(this.context.videoDownlinkBandwidthPolicy.getServerSideNetworkAdaption()) &&
            ...
            subscribe.videoSubscriptionConfiguration =
                (0, VideoPreferences_1.convertVideoPreferencesToSignalingClientVideoSubscriptionConfiguration)(this.context, videoSubscriptions.map((streamId) => {
        ...
        (_a = this.context.meetingSessionTimingManager) === null || _a === void 0 ? void 0 : _a.onSubscribeAckReceived();
