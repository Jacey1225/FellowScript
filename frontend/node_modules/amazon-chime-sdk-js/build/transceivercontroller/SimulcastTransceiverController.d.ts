...
export default class SimulcastTransceiverController extends DefaultTransceiverController {
    ...
    constructor(logger: Logger, browserBehavior: BrowserBehavior, meetingSessionContext?: AudioVideoControllerState, encodedTransformWorkerManager?: EncodedTransformWorkerManager);
