...
export default class NScaleVideoUplinkBandwidthPolicy implements VideoUplinkBandwidthPolicy {
    ...
    static readonly videoSVCCodecNames: string[];
    static readonly contentSVCCodecNames: string[];
    ...
    private enableHighResolutionFeature;
    private enableSVC;
    private isUsingSVCCodec;
    private scalabilityModePreferences;
    private currentScalabilityModeIndex;
    ...
    private updateOptimalParameters;
    ...
    private isContentShare;
    wantsVideoDependencyDescriptorRtpHeaderExtension(): boolean;
    setMeetingSupportedVideoSendCodecs(meetingSupportedVideoSendCodecPreferences: VideoCodecCapability[] | undefined, videoSendCodecPreferences: VideoCodecCapability[]): void;
