...
class VoiceFocusDeviceTransformer {
     ...
     */
    static async create(spec = {}, options = {}, config, 
     ...
     */
    static async configure(spec = {}, options = {}) {
     ...
     */
    async createTransformDevice(device, nodeOptions) {
        if (!this.supported) {
            // Fall back.
            return undefined;
        }
     ...
     */
    static async destroyVoiceFocus(transformer) {
        var _a;
        /* istanbul ignore next */
    ...
    async configure(preResolve = false) {
        const options = {
    ...
    async createVoiceFocus(config, preload) {
        const delegate = new VoiceFocusTransformDeviceDelegate_1.default();
        this.vf = await voicefocus_1.VoiceFocus.init(config, { delegate, preload, logger: this.vfLogger });
        return [this.vf, delegate];
    }
    async allocateVoiceFocus(preload) {
        // A little safety.
        /* istanbul ignore next */
        if (!this.supported) {
