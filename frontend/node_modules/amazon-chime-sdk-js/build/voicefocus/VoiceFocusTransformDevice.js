...
class VoiceFocusTransformDevice {
     ...
     */
    async chooseNewInnerDevice(inner) {
    ...
    async observeMeetingAudio(audioVideo) {
        if (!this.nodeOptions.es) {
            return;
        }
    ...
    async unObserveMeetingAudio(audioVideo) {
        if (!this.nodeOptions.es) {
            return;
        }
    ...
    async addFarEndStream(activeStream) {
        if (!this.nodeOptions.es ||
            !activeStream ||
    ...
    async removeFarendStream(inactiveStream) {
        var _a;
    ...
    async meetingAudioStreamBecameActive(activeStream) {
        this.addFarEndStream(activeStream);
    }
    async meetingAudioStreamBecameInactive(inactiveStream) {
