...
var PointerDragController = /** @class */ (function (_super) {
    ...
    PointerDragController.prototype.beginDrag = function (args) {
        ...
        // not the main one.
        var targetWindow = (_c = (_b = source.ownerDocument) === null || _b === void 0 ? void 0 : _b.defaultView) !== null && _c !== void 0 ? _c : globalThis.window;
        this._moveListener = (0, events_1.addDisposableListener)(targetWindow, 'pointermove', function (e) {
            var _a;
            if (e.pointerId !== ((_a = _this._active) === null || _a === void 0 ? void 0 : _a.pointerId)) {
                return;
            }
            _this._handleMove(e);
        });
