...
var DockviewComponent = /** @class */ (function (_super) {
    ...
    DockviewComponent.prototype._doAddPopoutGroup = function (itemToPopout, options) {
        ...
        return _window
            ...
            var referenceGroup = (_b = options === null || options === void 0 ? void 0 : options.referenceGroup) !== null && _b !== void 0 ? _b : (itemToPopout instanceof dockviewPanel_1.DockviewPanel
                ? itemToPopout.group
                : itemToPopout);
            ...
            if (options === null || options === void 0 ? void 0 : options.overridePopoutGridview) {
                ...
                group = (_c = options.overridePopoutGroup) !== null && _c !== void 0 ? _c : referenceGroup;
            }
            ...
            var popoutGridview = (_d = options === null || options === void 0 ? void 0 : options.overridePopoutGridview) !== null && _d !== void 0 ? _d : _this.createNestedGridview();
            if (!(options === null || options === void 0 ? void 0 : options.overridePopoutGridview)) {
            ...
            if (!(options === null || options === void 0 ? void 0 : options.overridePopoutGroup) &&
                ...
                if (itemToPopout instanceof dockviewPanel_1.DockviewPanel) {
                    ...
                    switch (referenceLocation) {
                        ...
                        case 'floating':
                        case 'popout':
                            floatingBox = (_e = _this.floatingGroups
                                .find(function (value) {
                                return value.group.api.id ===
                                    itemToPopout.api.id;
                            })) === null || _e === void 0 ? void 0 : _e.overlay.toJSON();
    ...
    DockviewComponent.prototype.deserializeEdgeGroups = function (edgeGroups, panels) {
        ...
        try {
            ...
            for (var _f = __values([
                ...
                var _position = _g.value;
                var fixedData = edgeGroups[_position];
                if (fixedData && !edgeService.has(_position)) {
                    var groupState = fixedData.group;
                    var id = (_e = groupState === null || groupState === void 0 ? void 0 : groupState.id) !== null && _e !== void 0 ? _e : "".concat(_position, "-group");
        ...
        try {
            ...
            for (var _h = __values(edgeService.entries()), _j = _h.next(); !_j.done; _j = _h.next()) {
                var _k = __read(_j.value, 2), position = _k[0], edgeGroup = _k[1];
                ...
                if (groupState) {
                    ...
                    try {
                        for (var createdPanels_1 = (e_20 = void 0, __values(createdPanels)), createdPanels_1_1 = createdPanels_1.next(); !createdPanels_1_1.done; createdPanels_1_1 = createdPanels_1.next()) {
                            var panel = createdPanels_1_1.value;
                        ...
                        try {
                            if (createdPanels_1_1 && !createdPanels_1_1.done && (_d = createdPanels_1.return)) _d.call(createdPanels_1);
                        }
                ...
                try {
                    ...
                    for (var _c = __values(members.length > 0
                        ...
                        if (!_this.isDisposed &&
                            ...
                            try {
                                for (var _e = (e_23 = void 0, __values(__spreadArray([], __read(orphan.panels), false))), _f = _e.next(); !_f.done; _f = _e.next()) {
                                    var panel = _f.value;
                                    _this.removePanel(panel, {
                                        removeEmptyGroup: false,
                                    });
    ...
    DockviewComponent.prototype._doAddPanel = function (options) {
        var _a, _b, _c, _d;
        if (this.panels.some(function (_) { return _.id === options.id; })) {
        ...
        if (options.position) {
            if ((0, options_1.isPanelOptionsWithPanel)(options.position)) {
                ...
                if (!referencePanel) {
                    var referenceId = typeof options.position.referencePanel === 'string'
                        ? options.position.referencePanel
                        : (_a = options.position.referencePanel) === null || _a === void 0 ? void 0 : _a.id;
                    throw new Error("dockview: referencePanel '".concat(referenceId, "' does not exist"));
                }
                ...
                index = options.position.index;
                if (!referenceGroup) {
                    var referenceId = typeof options.position.referenceGroup === 'string'
                        ? options.position.referenceGroup
                        : (_c = options.position.referenceGroup) === null || _c === void 0 ? void 0 : _c.id;
                    throw new Error("dockview: referenceGroup '".concat(referenceId, "' does not exist"));
                }
            }
            else {
        ...
        var panel;
        if (referenceGroup) {
            var target = (0, baseComponentGridview_1.toTarget)(((_d = options.position) === null || _d === void 0 ? void 0 : _d.direction) || 'within');
            if (options.floating) {
    ...
    DockviewComponent.prototype.removePanel = function (panel, options) {
        ...
        this.mutation('remove', function () {
            var _a;
            return _this._doRemovePanel(panel, {
    ...
    DockviewComponent.prototype._doAddGroup = function (options) {
        ...
        if (options) {
            ...
            if ((0, options_1.isGroupOptionsWithPanel)(options)) {
                ...
                var referencePanelId = typeof options.referencePanel === 'string'
                    ? options.referencePanel
                    : (_a = options.referencePanel) === null || _a === void 0 ? void 0 : _a.id;
                if (!referencePanel) {
                    throw new Error("dockview: reference panel ".concat(referencePanelId, " does not exist"));
                }
                referenceGroup = this.findGroup(referencePanel);
                if (!referenceGroup) {
                    throw new Error("dockview: reference group for reference panel ".concat(referencePanelId, " does not exist"));
                }
            }
                ...
                if (!referenceGroup) {
                    var referenceId = typeof options.referenceGroup === 'string'
                        ? options.referenceGroup
                        : (_c = options.referenceGroup) === null || _c === void 0 ? void 0 : _c.id;
                    throw new Error("dockview: reference group ".concat(referenceId, " does not exist"));
                }
            }
            else {
        ...
        if (target === 'center') {
            ...
            try {
                for (var tabGroupSnapshots_1 = __values(tabGroupSnapshots), tabGroupSnapshots_1_1 = tabGroupSnapshots_1.next(); !tabGroupSnapshots_1_1.done; tabGroupSnapshots_1_1 = tabGroupSnapshots_1.next()) {
                    ...
                    try {
                        for (var _h = (e_33 = void 0, __values(snapshot.panelIds)), _j = _h.next(); !_j.done; _j = _h.next()) {
            ...
            if (from.api.location.type === 'edge') {
                ...
                try {
                    for (var tabGroupSnapshots_2 = __values(tabGroupSnapshots), tabGroupSnapshots_2_1 = tabGroupSnapshots_2.next(); !tabGroupSnapshots_2_1.done; tabGroupSnapshots_2_1 = tabGroupSnapshots_2.next()) {
                        ...
                        try {
                            for (var _k = (e_35 = void 0, __values(snapshot.panelIds)), _l = _k.next(); !_l.done; _l = _k.next()) {
    ...
    DockviewComponent.prototype.updateTheme = function () {
        ...
        if (theme.dndOverlayBorder === undefined) {
            ...
            (_l = this._shellManager) === null || _l === void 0 ? void 0 : _l.element.style.removeProperty('--dv-drag-over-border');
        }
        else {
            this.element.style.setProperty('--dv-drag-over-border', theme.dndOverlayBorder);
            (_m = this._shellManager) === null || _m === void 0 ? void 0 : _m.element.style.setProperty('--dv-drag-over-border', theme.dndOverlayBorder);
        }
