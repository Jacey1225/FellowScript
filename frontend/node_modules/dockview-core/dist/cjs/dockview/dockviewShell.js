...
var EdgeGroupView = /** @class */ (function () {
    function EdgeGroupView(options, group, orientation, gapAdd) {
        if (gapAdd === void 0) { gapAdd = 0; }
        var _a, _b, _c;
        ...
        this._tabSizeDisposables = new lifecycle_1.CompositeDisposable();
        this._group = group;
    ...
    Object.defineProperty(EdgeGroupView.prototype, "_effectiveBaseCollapsed", {
        /**
     ...
     */
    EdgeGroupView.prototype._observeTabStrip = function () {
        var _this = this;
        var strip = this._group.element.querySelector('.dv-tabs-and-actions-container');
        if (!strip) {
            return;
        }
        this._tabSizeDisposables.addDisposables((0, dom_1.watchElementResize)(strip, function () {
            _this._applyMeasuredTabSize(_this._orientation === 'vertical'
                ? strip.offsetHeight
                : strip.offsetWidth);
        }));
    };
     ...
     */
    EdgeGroupView.prototype._applyMeasuredTabSize = function (size) {
     ...
     */
    EdgeGroupView.prototype.updateSizing = function (baseCollapsedSize, baseMinimumSize, gapAdd) {
...
var ShellManager = /** @class */ (function () {
    function ShellManager(container, dockviewElement, layoutGrid, gap, defaultCollapsedSize) {
        ...
        this._disposables.addDisposables((0, dom_1.watchElementResize)(this._shellElement, function (entry) {
             ...
             */
            if (!_this._shellElement.offsetParent) {
                return;
            }
            if (!(0, dom_1.isInDocument)(_this._shellElement)) {
                return;
            }
    ...
    ShellManager.prototype.addEdgeView = function (position, options, group) {
        ...
        var view = new EdgeGroupView(__assign({ collapsedSize: this._defaultCollapsedSize }, options), group, orientation, gapAdd);
