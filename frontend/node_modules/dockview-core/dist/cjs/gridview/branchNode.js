...
var BranchNode = /** @class */ (function (_super) {
    ...
    Object.defineProperty(BranchNode.prototype, "priority", {
        get: function () {
            ...
            var priorities = new Set(this.children.map(function (c) { var _a; return (_a = c.priority) !== null && _a !== void 0 ? _a : splitview_1.LayoutPriority.Normal; }));
            if (priorities.has(splitview_1.LayoutPriority.High)) {
                return splitview_1.LayoutPriority.High;
            }
            else if (priorities.has(splitview_1.LayoutPriority.Low)) {
