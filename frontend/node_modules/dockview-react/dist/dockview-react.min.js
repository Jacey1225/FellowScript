...
/**
   ...
   * @link https://github.com/mathuo/dockview
   * @license MIT
   */class oo{constructor(e){this._host=e}attachToGroup(e){return new h(e.model.onDidCreateTabGroup(e=>{this._host.fireDidCreateTabGroup(e)}),e.model.onDidDestroyTabGroup(e=>{this._host.fireDidDestroyTabGroup(e)}),e.model.onDidAddPanelToTabGroup(e=>{this._host.fireDidAddPanelToTabGroup(e)}),e.model.onDidRemovePanelFromTabGroup(e=>{this._host.fireDidRemovePanelFromTabGroup(e)}),e.model.onDidTabGroupChange(e=>{this._host.fireDidTabGroupChange(e)}),e.model.onDidTabGroupCollapsedChange(e=>{this._host.fireDidTabGroupCollapsedChange(e)}))}dispose(){}}const no=Jt({name:"TabGroupChips",serviceKey:"tabGroupChipsService",create:e=>new oo(e),init:(e,t)=>{const i=new Map;return new h(e.onDidAddGroup(e=>{i.set(e,t.attachToGroup(e))}),e.onDidRemoveGroup(e=>{var t;null===(t=i.get(e))||void 0===t||t.dispose(),i.delete(e)}),{dispose:()=>{for(const e of i.values())e.dispose();i.clear()}})}});function ro(e){if(!(e instanceof HTMLElement))return;const t=M(e);return(null==t?void 0:t.style.zIndex)?`calc(${t.style.zIndex} * 2)`:void 0}let so=0;const ao=()=>"dv-ctx-menu-item-"+so++;function lo(e){return"object"==typeof e}function ho(e,t,i,o){const n=document.createElement("div");return n.className="dv-context-menu-item",n.setAttribute("role","menuitem"),o&&(n.classList.add("dv-context-menu-item--disabled"),n.setAttribute("aria-disabled","true")),n.textContent=e,o||n.addEventListener("click",()=>{i(),t()}),n}function po(){const e=document.createElement("div");return e.className="dv-context-menu-separator",e.setAttribute("role","separator"),e}function co(e){const t=document.createElement("div");t.className="dv-context-menu-rename";const i=document.createElement("input");return i.className="dv-context-menu-rename-input",i.type="text",i.placeholder="Name This Group",i.value=e.label,i.addEventListener("input",()=>{e.setLabel(i.value)}),i.addEventListener("keydown",e=>{"Escape"!==e.key&&"Enter"!==e.key&&e.stopPropagation()}),i.addEventListener("click",e=>{e.stopPropagation()}),t.appendChild(i),function(){if(void 0===globalThis.window||!globalThis.matchMedia)return!1;const e=globalThis.matchMedia("(pointer: coarse)").matches,t=globalThis.matchMedia("(pointer: fine)").matches;return e&&!t}()||requestAnimationFrame(()=>{i.focus(),i.select()}),t}function vo(e,t){const i=document.createElement("div");if(i.className="dv-context-menu-color-picker",!t.enabled)return i;for(const o of t.entries()){const t=document.createElement("div");t.className="dv-context-menu-color-swatch",t.style.setProperty("--dv-tab-group-color",o.value),o.label&&(t.title=o.label),e.color===o.id&&t.classList.add("dv-context-menu-color-swatch--selected"),t.addEventListener("click",()=>{e.setColor(o.id)}),i.appendChild(t)}return i}class uo{constructor(e){this.accessor=e}show(e,t,i){var o,n;if(!this.accessor.options.getTabContextMenuItems)return;const r=this.accessor.options.getTabContextMenuItems({panel:e,group:t,api:this.accessor.api,event:i});if(0===r.length)return;i.preventDefault();const s=this.accessor.getPopupServiceForGroup(t),a=()=>s.close(),d=document.createElement("div");d.className="dv-context-menu",d.setAttribute("role","menu");for(const i of r)if("separator"===i)d.appendChild(po());else if("close"===i)d.appendChild(ho("Close",a,()=>e.api.close()));else if("closeOthers"===i)d.appendChild(ho("Close Others",a,()=>{t.panels.filter(t=>t!==e).forEach(e=>e.api.close())}));else if("closeAll"===i)d.appendChild(ho("Close All",a,()=>{[...t.panels].forEach(e=>e.api.close())}));else if(lo(i)&&i.element)d.appendChild(i.element);else if(lo(i)&&i.component){const r=null===(n=(o=this.accessor.options).createContextMenuItemComponent)||void 0===n?void 0:n.call(o,{id:ao(),component:i.component});r&&(r.init({panel:e,group:t,api:this.accessor.api,close:a,componentProps:i.componentProps}),d.appendChild(r.element))}else lo(i)&&i.label&&d.appendChild(ho(i.label,a,()=>{var e;return null===(e=i.action)||void 0===e?void 0:e.call(i)},i.disabled));s.openPopover(d,{x:i.clientX,y:i.clientY,zIndex:ro(i.target)})}showForChip(e,t,i){if(!this.accessor.options.getTabGroupChipContextMenuItems)return;const o=this.accessor.options.getTabGroupChipContextMenuItems({tabGroup:e,group:t,api:this.accessor.api,event:i});if(0===o.length)return;i.preventDefault();const n=this.accessor.getPopupServiceForGroup(t),r=()=>n.close(),s=document.createElement("div");s.className="dv-context-menu",s.setAttribute("role","menu");for(const t of o)"separator"===t?s.appendChild(po()):"rename"===t?s.appendChild(co(e)):"colorPicker"===t?s.appendChild(vo(e,this.accessor.tabGroupColorPalette)):lo(t)&&t.element?s.appendChild(t.element):lo(t)&&t.label&&s.appendChild(ho(t.label,r,()=>{var e;return null===(e=t.action)||void 0===e?void 0:e.call(t)},t.disabled));n.openPopover(s,{x:i.clientX,y:i.clientY,zIndex:ro(i.target)})}}const go=Jt({name:"ContextMenu",serviceKey:"contextMenuService",create:e=>new uo(e)});class mo{constructor(e){this.host=e}dispatchWillDragPanel(e){this.host.fireWillDragPanel(e)}dispatchWillDragGroup(e){this.host.fireWillDragGroup(e)}dispatchWillDrop(e){this.host.fireWillDrop(e)}dispatchWillShowOverlay(e){this.host.fireWillShowOverlay(e)}buildGroupDragGhost(e){const t=this.host.options.createGroupDragGhostComponent;if(!t)return;const i=t(e);return i.init({group:e,api:this.host.api}),{element:i.element,offsetX:30,offsetY:-10,dispose:i.dispose?()=>{var e;return null===(e=i.dispose)||void 0===e?void 0:e.call(i)}:void 0}}resolveOverlayModel(e,t){var i,o;return null===(o=(i=this.host.options).dropOverlayModel)||void 0===o?void 0:o.call(i,{location:e,group:t})}showPreviewOverlay(t,i){const o=t.model.contentDropTarget;return o.showOverlay(i),e.DockviewDisposable.from(()=>o.clearOverlay())}dispose(){}}const bo=Jt({name:"AdvancedDnD",serviceKey:"advancedDnDService",create:e=>new mo(e)}),fo="data-dv-kbd-moving";function _o(e,t){const i=t.toLowerCase().split("+"),o=i[i.length-1],n=i.slice(0,-1);return e.ctrlKey===n.includes("ctrl")&&e.shiftKey===n.includes("shift")&&e.altKey===n.includes("alt")&&e.metaKey===(n.includes("meta")||n.includes("cmd"))&&e.key.toLowerCase()===o}function wo(e){const t=e.keyboardNavigation;if(t)return!0===t?{}:t}const Do={nextTab:"ctrl+]",prevTab:"ctrl+[",focusNextGroup:"f6",focusPrevGroup:"shift+f6",focusTabs:"ctrl+shift+\\"};class xo extends h{constructor(e){super(),this.host=e,this._focusWasInside=!1;const t=e.rootElement.ownerDocument,i=e=>this._onKeyDown(e);t.addEventListener("keydown",i,!0);const o=e=>{const t=e.target;t instanceof HTMLElement&&this.host.rootElement.contains(t)&&!t.closest('[role="dialog"]')&&(this._lastNonFloatFocus=t)};t.addEventListener("focusin",o,!0);const n=e=>this._onFloatingEscape(e);t.addEventListener("keydown",n,!1),this.addDisposables({dispose:()=>t.removeEventListener("keydown",i,!0)},{dispose:()=>t.removeEventListener("focusin",o,!0)},{dispose:()=>t.removeEventListener("keydown",n,!1)},e.onWillMutateLayout(e=>{"remove"===e.kind&&this._nav&&(this._focusWasInside=this._isFocusInside())}),e.onDidMutateLayout(e=>{"remove"===e.kind&&this._nav&&this._focusWasInside&&!this._isFocusInside()&&this._restoreFocus()}))}get _moveActive(){return this.host.rootElement.hasAttribute(fo)}_isFocusInside(){const e=this.host.rootElement.ownerDocument.activeElement;return e instanceof Node&&this.host.rootElement.contains(e)}_onFloatingEscape(e){if(!this._nav||this._moveActive||e.defaultPrevented||"Escape"!==e.key)return;const t=e.target;if(!(t instanceof Element))return;const i=t.closest('[role="dialog"]');i&&this.host.rootElement.contains(i)&&(e.preventDefault(),e.stopPropagation(),this._returnFocusFromFloat())}_trapFloatTab(e){const t=e.target;if(!(t instanceof Element))return!1;const i=t.closest('[role="dialog"]');if(!i||!this.host.rootElement.contains(i))return!1;e.preventDefault();const o=this._tabbables(i);if(0===o.length)return!0;const n=i.ownerDocument.activeElement,r=n instanceof HTMLElement?o.indexOf(n):-1,s=o.length;return o[-1===r?e.shiftKey?s-1:0:(r+(e.shiftKey?-1:1)+s)%s].focus(),!0}_tabbables(e){const t=e.querySelectorAll("a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]");return Array.from(t).filter(e=>e.tabIndex>=0)}_returnFocusFromFloat(){var e;const t=this._lastNonFloatFocus;t&&t.isConnected&&this.host.rootElement.contains(t)&&!t.closest('[role="dialog"]')?t.focus():null===(e=this.host.groups.find(e=>"grid"===e.api.location.type))||void 0===e||e.model.focusContent()}get _nav(){return wo(this.host.options)}get _keymap(){var e;return Object.assign(Object.assign({},Do),null===(e=this._nav)||void 0===e?void 0:e.keymap)}_onKeyDown(e){if(!this._nav)return;if(this._moveActive)return;if(!(e.target instanceof Node&&this.host.rootElement.contains(e.target)))return;if("Tab"===e.key&&this._trapFloatTab(e))return;const t=this._keymap;_o(e,t.nextTab)?(this._consume(e),this._switchTab(!1)):_o(e,t.prevTab)?(this._consume(e),this._switchTab(!0)):_o(e,t.focusNextGroup)?(this._consume(e),this._cycleGroup(!1)):_o(e,t.focusPrevGroup)?(this._consume(e),this._cycleGroup(!0)):_o(e,t.focusTabs)&&(this._consume(e),this._focusTabs())}_focusTabs(){var e;null===(e=this.host.activeGroup)||void 0===e||e.model.focusActiveTab()}_switchTab(e){const t=this.host.activeGroup;t&&(e?t.model.moveToPrevious():t.model.moveToNext(),t.model.focusContent())}_cycleGroup(e){const t=this.host.activeGroup,i=t?this.host.adjacentGroup(t,e):this.host.groups[0];this._focusGroup(i)}_focusGroup(e){e&&(e.api.setActive(),e.model.focusContent())}_restoreFocus(){var e;null===(e=this.host.activeGroup)||void 0===e||e.model.focusContent()}_consume(e){e.preventDefault(),e.stopPropagation()}}const yo=Jt({name:"Accessibility",serviceKey:"accessibilityService",create:e=>new xo(e)}),Co={ArrowLeft:"left",ArrowRight:"right",ArrowUp:"top",ArrowDown:"bottom"},So="ctrl+shift+arrowleft",ko="ctrl+shift+arrowright",zo="ctrl+shift+arrowup",Go="ctrl+shift+arrowdown",Po="ctrl+m";class To extends h{constructor(e){super(),this.host=e,this._move=null;const t=e.rootElement.ownerDocument,i=e=>this._onKeyDown(e);t.addEventListener("keydown",i,!0),this.addDisposables({dispose:()=>this._exit()},{dispose:()=>t.removeEventListener("keydown",i,!0)})}get _enabled(){return!!wo(this.host.options)}get _keymap(){var e,t,i,o,n,r,s;const a=null!==(t=null===(e=wo(this.host.options))||void 0===e?void 0:e.keymap)&&void 0!==t?t:{};return{focusGroupLeft:null!==(i=a.focusGroupLeft)&&void 0!==i?i:So,focusGroupRight:null!==(o=a.focusGroupRight)&&void 0!==o?o:ko,focusGroupUp:null!==(n=a.focusGroupUp)&&void 0!==n?n:zo,focusGroupDown:null!==(r=a.focusGroupDown)&&void 0!==r?r:Go,dock:null!==(s=a.dock)&&void 0!==s?s:Po}}get _messages(){return Si(this.host.options.messages)}_onKeyDown(e){if(!this._enabled)return;if(this._move)return void this._onMoveKey(e);if(!(e.target instanceof Node&&this.host.rootElement.contains(e.target)))return;const t=this._keymap;_o(e,t.dock)?this._enterMoveMode(e):_o(e,t.focusGroupLeft)?(this._consume(e),this._focusGroupInDirection("left")):_o(e,t.focusGroupRight)?(this._consume(e),this._focusGroupInDirection("right")):_o(e,t.focusGroupUp)?(this._consume(e),this._focusGroupInDirection("up")):_o(e,t.focusGroupDown)&&(this._consume(e),this._focusGroupInDirection("down"))}_focusGroupInDirection(e){const t=this.host.activeGroup;t&&this._focusGroup(this.host.adjacentGroupInDirection(t,e))}_focusGroup(e){e&&(e.api.setActive(),e.model.focusContent())}_restoreFocus(){var e;null===(e=this.host.activeGroup)||void 0===e||e.model.focusContent()}_enterMoveMode(e){const t=this.host.activePanel,i=this.host.groups;if(!t||0===i.length)return;e.preventDefault(),e.stopPropagation();const o=Math.max(0,i.indexOf(t.group));this._move={source:t,groups:i,groupIndex:o,phase:"target",position:"center"},this.host.rootElement.setAttribute(fo,""),this._render()}_onMoveKey(e){const t=this._move;if("Escape"===e.key)return this._consume(e),void("edge"===t.phase?(t.phase="target",t.position="center",this._render()):(this._exit(),this.host.announce(this._messages.moveCancelled()),this._restoreFocus()));if("Enter"===e.key)return this._consume(e),void("target"===t.phase?(t.phase="edge",t.position="center",this._render()):this._commit());if("target"===t.phase){const i=t.groups.length;return void("ArrowRight"===e.key||"ArrowDown"===e.key?(this._consume(e),t.groupIndex=(t.groupIndex+1)%i,this._render()):"ArrowLeft"!==e.key&&"ArrowUp"!==e.key||(this._consume(e),t.groupIndex=(t.groupIndex-1+i)%i,this._render()))}const i=Co[e.key];i?(this._consume(e),t.position=i,this._render()):" "!==e.key&&"c"!==e.key&&"C"!==e.key||(this._consume(e),t.position="center",this._render())}_render(){var e,t;const i=this._move,o=i.groups[i.groupIndex];this._clearPreview(),this._preview=this.host.showDropPreview(o,i.position);const n=null!==(t=null===(e=o.activePanel)||void 0===e?void 0:e.title)&&void 0!==t?t:o.id,r=this._messages;"target"===i.phase?this.host.announce(r.movePickTarget(this._label(i.source),n,i.groupIndex+1,i.groups.length)):this.host.announce(r.movePickEdge(i.position,n))}_commit(){var e,t;const i=this._move,o=i.groups[i.groupIndex],n=i.position,r=i.source,s=null!==(t=null===(e=o.activePanel)||void 0===e?void 0:e.title)&&void 0!==t?t:o.id,a=this._messages;this._exit();try{this.host.dockPanel(r,o,n),this.host.announce(a.moveCommitted(this._label(r),s,n))}catch(e){this.host.announce(a.moveNotAllowed())}this._restoreFocus()}_exit(){this._clearPreview(),this._move=null,this.host.rootElement.removeAttribute(fo)}_clearPreview(){var e;null===(e=this._preview)||void 0===e||e.dispose(),this._preview=void 0}_consume(e){e.preventDefault(),e.stopPropagation()}_label(e){var t;return null!==(t=e.title)&&void 0!==t?t:e.id}}Jt({name:"KeyboardDocking",serviceKey:"keyboardDockingService",create:e=>new To(e),dependsOn:[bo,Pi]});Qt([no,go,bo,yo]),ii();const Ao=(e,i)=>{const[,o]=t.useState(0),n=t.useRef(e.componentProps);return t.useImperativeHandle(i,()=>({update:e=>{n.current=Object.assign(Object.assign({},n.current),e),o(e=>e+1)}}),[]),t.createElement(e.component,n.current)};Ao.displayName="DockviewReactJsBridge";const Io=(()=>{let e=1;return{next:()=>`dockview_react_portal_key_${(e++).toString()}`}})(),Eo=t.createContext({});class Oo{constructor(e,t,i,o,n){this.parent=e,this.portalStore=t,this.component=i,this.parameters=o,this.context=n,this._initialProps={},this.disposed=!1,this.createPortal()}update(e){if(this.disposed)throw new Error("invalid operation: resource is already disposed");this.componentInstance?this.componentInstance.update(e):this._initialProps=Object.assign(Object.assign({},this._initialProps),e)}createPortal(){if(this.disposed)throw new Error("invalid operation: resource is already disposed");if(!Lo(this.component))throw new Error("Dockview: Only React.memo(...), React.ForwardRef(...) and functional components are accepted as components");const e=t.createElement(t.forwardRef(Ao),{component:this.component,componentProps:this.parameters,ref:e=>{this.componentInstance=e,Object.keys(this._initialProps).length>0&&(this.componentInstance.update(this._initialProps),this._initialProps={})}}),o=this.context?t.createElement(Eo.Provider,{value:this.context},e):e,n=i.createPortal(o,this.parent,Io.next());this.ref={portal:n,disposable:this.portalStore.addPortal(n)}}dispose(){var e;null===(e=this.ref)||void 0===e||e.disposable.dispose(),this.disposed=!0}}const Mo=()=>{const[i,o]=t.useState([]);t.useDebugValue(`Portal count: ${i.length}`);return[i,t.useCallback(t=>{o(e=>[...e,t]);let i=!1;return e.DockviewDisposable.from(()=>{if(i)throw new Error("invalid operation: resource already disposed");i=!0,o(e=>e.filter(e=>e!==t))})},[])]};function Lo(e){return"function"==typeof e||!!(null==e?void 0:e.$$typeof)}class Vo{get element(){return this._element}constructor(e,t,i){this.id=e,this.component=t,this.reactPortalStore=i,this._onDidFocus=new m,this.onDidFocus=this._onDidFocus.event,this._onDidBlur=new m,this.onDidBlur=this._onDidBlur.event,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.height="100%",this._element.style.width="100%"}focus(){}init(e){this.part=new Oo(this.element,this.reactPortalStore,this.component,{params:e.params,api:e.api,containerApi:e.containerApi})}update(e){var t;null===(t=this.part)||void 0===t||t.update({params:e.params})}layout(e,t){}dispose(){var e;this._onDidFocus.dispose(),this._onDidBlur.dispose(),null===(e=this.part)||void 0===e||e.dispose()}}class Ro{get element(){return this._element}constructor(e,t,i){this.id=e,this.component=t,this.reactPortalStore=i,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.height="100%",this._element.style.width="100%"}focus(){}init(e){this.part=new Oo(this.element,this.reactPortalStore,this.component,{params:e.params,api:e.api,containerApi:e.containerApi,tabLocation:e.tabLocation})}update(e){var t;null===(t=this.part)||void 0===t||t.update({params:e.params})}layout(e,t){}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}class No{get element(){return this._element}constructor(e,t,i){this.id=e,this.component=t,this.reactPortalStore=i,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.height="100%",this._element.style.width="100%"}init(e){this.part=new Oo(this.element,this.reactPortalStore,this.component,{group:e.group,containerApi:e.containerApi})}focus(){}update(e){var t,i,o;this.parameters&&(this.parameters.params=e.params),null===(t=this.part)||void 0===t||t.update({params:null!==(o=null===(i=this.parameters)||void 0===i?void 0:i.params)&&void 0!==o?o:{}})}layout(e,t){}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}class Wo{get element(){return this._element}get part(){return this._part}constructor(e,t,i){this.component=e,this.reactPortalStore=t,this._group=i,this.mutableDisposable=new p,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.height="100%",this._element.style.width="100%"}init(e){this.mutableDisposable.value=new h(this._group.model.onDidAddPanel(()=>{this.updatePanels()}),this._group.model.onDidRemovePanel(()=>{this.updatePanels()}),this._group.model.onDidActivePanelChange(()=>{this.updateActivePanel()}),e.api.onDidActiveChange(()=>{this.updateGroupActive()}),e.api.onDidLocationChange(e=>{this.updateLocation(e.location)})),this._part=new Oo(this.element,this.reactPortalStore,this.component,{api:e.api,containerApi:e.containerApi,panels:this._group.model.panels,activePanel:this._group.model.activePanel,isGroupActive:this._group.api.isActive,group:this._group,headerPosition:this._group.model.headerPosition,location:e.api.location})}dispose(){var e;this.mutableDisposable.dispose(),null===(e=this._part)||void 0===e||e.dispose()}update(e){var t;null===(t=this._part)||void 0===t||t.update(e.params)}updatePanels(){this.update({params:{panels:this._group.model.panels}})}updateActivePanel(){this.update({params:{activePanel:this._group.model.activePanel}})}updateGroupActive(){this.update({params:{isGroupActive:this._group.api.isActive}})}updateLocation(e){this.update({params:{location:e}})}}class Ho{get element(){return this._element}constructor(e,t,i){this.id=e,this.component=t,this.reactPortalStore=i,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.height="100%",this._element.style.width="100%"}init(e){this.part=new Oo(this._element,this.reactPortalStore,this.component,e)}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}class Fo{get element(){return this._element}constructor(e,t){this.component=e,this.reactPortalStore=t,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.display="inline-flex"}init(e){this.part=new Oo(this._element,this.reactPortalStore,this.component,{tabGroup:e.tabGroup,api:e.api})}update(e){var t;null===(t=this.part)||void 0===t||t.update({tabGroup:e.tabGroup})}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}class Bo{get element(){return this._element}constructor(e,t){this.component=e,this.reactPortalStore=t,this._element=document.createElement("div"),this._element.className="dv-react-part",this._element.style.display="inline-flex"}init(e){this.part=new Oo(this._element,this.reactPortalStore,this.component,{group:e.group,api:e.api})}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}function $o(e,t){return e?i=>new Wo(e,t,i):void 0}const Uo="props.defaultTabComponent";const jo=t.forwardRef((e,i)=>{const o=t.useRef(null),n=t.useRef(void 0),[r,s]=Mo();t.useImperativeHandle(i,()=>o.current,[]);const a=t.useRef({});return t.useEffect(()=>{const t={};Ct.forEach(i=>{const o=i,n=e[o];o in e&&n!==a.current[o]&&(t[o]=n)}),n.current&&n.current.updateOptions(t),a.current=e},Ct.map(t=>e[t])),t.useEffect(()=>{var t;if(!o.current)return;const i=null!==(t=e.tabComponents)&&void 0!==t?t:{};e.defaultTabComponent&&(i[Uo]=e.defaultTabComponent);const r={createLeftHeaderActionComponent:$o(e.leftHeaderActionsComponent,{addPortal:s}),createRightHeaderActionComponent:$o(e.rightHeaderActionsComponent,{addPortal:s}),createPrefixHeaderActionComponent:$o(e.prefixHeaderActionsComponent,{addPortal:s}),createComponent:t=>new Vo(t.id,e.components[t.name],{addPortal:s}),createTabComponent:e=>new Ro(e.id,i[e.name],{addPortal:s}),createWatermarkComponent:e.watermarkComponent?()=>new No("watermark",e.watermarkComponent,{addPortal:s}):void 0,defaultTabComponent:e.defaultTabComponent?Uo:void 0,createContextMenuItemComponent:e=>{if(e.component)return new Ho(e.id,e.component,{addPortal:s})}},a=function(e){return Ct.reduce((t,i)=>(i in e&&(t[i]=e[i]),t),{})}(e);if(e.tabGroupChipComponent){const t=e.tabGroupChipComponent;a.createTabGroupChipComponent=()=>new Fo(t,{addPortal:s})}if(e.groupDragGhostComponent){const t=e.groupDragGhostComponent;a.createGroupDragGhostComponent=()=>new Bo(t,{addPortal:s})}const d=Qi(o.current,Object.assign(Object.assign({},a),r)),{clientWidth:l,clientHeight:h}=o.current;return d.layout(l,h),e.onReady&&e.onReady({api:d}),n.current=d,()=>{n.current=void 0,d.dispose()}},[]),t.useEffect(()=>{if(!n.current)return()=>{};const t=n.current.onDidDrop(t=>{e.onDidDrop&&e.onDidDrop(t)});return()=>{t.dispose()}},[e.onDidDrop]),t.useEffect(()=>{if(!n.current)return()=>{};const t=n.current.onWillDrop(t=>{e.onWillDrop&&e.onWillDrop(t)});return()=>{t.dispose()}},[e.onWillDrop]),t.useEffect(()=>{n.current&&n.current.updateOptions({createTabGroupChipComponent:e.tabGroupChipComponent?()=>new Fo(e.tabGroupChipComponent,{addPortal:s}):void 0})},[e.tabGroupChipComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createGroupDragGhostComponent:e.groupDragGhostComponent?()=>new Bo(e.groupDragGhostComponent,{addPortal:s}):void 0})},[e.groupDragGhostComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createComponent:t=>new Vo(t.id,e.components[t.name],{addPortal:s})})},[e.components]),t.useEffect(()=>{var t;if(!n.current)return;const i=null!==(t=e.tabComponents)&&void 0!==t?t:{};e.defaultTabComponent&&(i[Uo]=e.defaultTabComponent),n.current.updateOptions({defaultTabComponent:e.defaultTabComponent?Uo:void 0,createTabComponent:e=>new Ro(e.id,i[e.name],{addPortal:s})})},[e.tabComponents,e.defaultTabComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createWatermarkComponent:e.watermarkComponent?()=>new No("watermark",e.watermarkComponent,{addPortal:s}):void 0})},[e.watermarkComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createRightHeaderActionComponent:$o(e.rightHeaderActionsComponent,{addPortal:s})})},[e.rightHeaderActionsComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createLeftHeaderActionComponent:$o(e.leftHeaderActionsComponent,{addPortal:s})})},[e.leftHeaderActionsComponent]),t.useEffect(()=>{n.current&&n.current.updateOptions({createPrefixHeaderActionComponent:$o(e.prefixHeaderActionsComponent,{addPortal:s})})},[e.prefixHeaderActionsComponent]),t.createElement("div",{style:{height:"100%",width:"100%"},ref:o},r)});jo.displayName="DockviewComponent","function"==typeof SuppressedError&&SuppressedError;const Yo=()=>t.createElement("svg",{height:"11",width:"11",viewBox:"0 0 28 28","aria-hidden":"false",focusable:!1,className:"dv-svg"},t.createElement("path",{d:"M2.1 27.3L0 25.2L11.55 13.65L0 2.1L2.1 0L13.65 11.55L25.2 0L27.3 2.1L15.75 13.65L27.3 25.2L25.2 27.3L13.65 15.75L2.1 27.3Z"}));class Jo extends qi{constructor(e,t,i,o){super(e,t),this.reactComponent=i,this.reactPortalStore=o}getComponent(){var e,t;return new Oo(this.element,this.reactPortalStore,this.reactComponent,{params:null!==(t=null===(e=this._params)||void 0===e?void 0:e.params)&&void 0!==t?t:{},api:this.api,containerApi:new be(this._params.accessor)})}}const Xo=t.forwardRef((e,i)=>{const o=t.useRef(null),n=t.useRef(void 0),[r,s]=Mo();t.useImperativeHandle(i,()=>o.current,[]);const a=t.useRef({});return t.useEffect(()=>{const t={};Z.forEach(i=>{const o=i,n=e[o];o in e&&n!==a.current[o]&&(t[o]=n)}),n.current&&n.current.updateOptions(t),a.current=e},Z.map(t=>e[t])),t.useEffect(()=>{if(!o.current)return()=>{};const t={createComponent:t=>new Jo(t.id,t.name,e.components[t.name],{addPortal:s})},i=eo(o.current,Object.assign(Object.assign({},function(e){return Z.reduce((t,i)=>(i in e&&(t[i]=e[i]),t),{})}(e)),t)),{clientWidth:r,clientHeight:a}=o.current;return i.layout(r,a),e.onReady&&e.onReady({api:i}),n.current=i,()=>{n.current=void 0,i.dispose()}},[]),t.useEffect(()=>{n.current&&n.current.updateOptions({createComponent:t=>new Jo(t.id,t.name,e.components[t.name],{addPortal:s})})},[e.components]),t.createElement("div",{style:{height:"100%",width:"100%"},ref:o},r)});Xo.displayName="SplitviewComponent";class Zo extends Ot{constructor(e,t,i,o){super(e,t),this.reactComponent=i,this.reactPortalStore=o}getComponent(){var e,t;return new Oo(this.element,this.reactPortalStore,this.reactComponent,{params:null!==(t=null===(e=this._params)||void 0===e?void 0:e.params)&&void 0!==t?t:{},api:this.api,containerApi:new _e(this._params.accessor)})}}const Ko=t.forwardRef((e,i)=>{const o=t.useRef(null),n=t.useRef(void 0),[r,s]=Mo();t.useImperativeHandle(i,()=>o.current,[]);const a=t.useRef({});return t.useEffect(()=>{const t={};ce.forEach(i=>{const o=i,n=e[o];o in e&&n!==a.current[o]&&(t[o]=n)}),n.current&&n.current.updateOptions(t),a.current=e},ce.map(t=>e[t])),t.useEffect(()=>{if(!o.current)return()=>{};const t={createComponent:t=>new Zo(t.id,t.name,e.components[t.name],{addPortal:s})},i=to(o.current,Object.assign(Object.assign({},function(e){return ce.reduce((t,i)=>(i in e&&(t[i]=e[i]),t),{})}(e)),t)),{clientWidth:r,clientHeight:a}=o.current;return i.layout(r,a),e.onReady&&e.onReady({api:i}),n.current=i,()=>{n.current=void 0,i.dispose()}},[]),t.useEffect(()=>{n.current&&n.current.updateOptions({createComponent:t=>new Zo(t.id,t.name,e.components[t.name],{addPortal:s})})},[e.components]),t.createElement("div",{style:{height:"100%",width:"100%"},ref:o},r)});Ko.displayName="GridviewComponent";class qo{get element(){return this._element}constructor(e,t,i){this.id=e,this.component=t,this.reactPortalStore=i,this._element=document.createElement("div"),this._element.style.height="100%",this._element.style.width="100%"}init(e){this.part=new Oo(this.element,this.reactPortalStore,this.component,{params:e.params,api:e.api,title:e.title,containerApi:e.containerApi})}toJSON(){return{id:this.id}}update(e){var t;null===(t=this.part)||void 0===t||t.update(e.params)}dispose(){var e;null===(e=this.part)||void 0===e||e.dispose()}}const Qo=t.forwardRef((e,i)=>{const o=t.useRef(null),n=t.useRef(void 0),[r,s]=Mo();t.useImperativeHandle(i,()=>o.current,[]);const a=t.useRef({});return t.useEffect(()=>{const t={};Fe.forEach(i=>{const o=i,n=e[o];o in e&&n!==a.current[o]&&(t[o]=n)}),n.current&&n.current.updateOptions(t),a.current=e},Fe.map(t=>e[t])),t.useEffect(()=>{var t;if(!o.current)return()=>{};const i=null!==(t=e.headerComponents)&&void 0!==t?t:{},r={createComponent:t=>new qo(t.id,e.components[t.name],{addPortal:s}),createHeaderComponent:e=>new qo(e.id,i[e.name],{addPortal:s})},a=io(o.current,Object.assign(Object.assign({},function(e){return Fe.reduce((t,i)=>(i in e&&(t[i]=e[i]),t),{})}(e)),r)),{clientWidth:d,clientHeight:l}=o.current;return a.layout(d,l),e.onReady&&e.onReady({api:a}),n.current=a,()=>{n.current=void 0,a.dispose()}},[]),t.useEffect(()=>{n.current&&n.current.updateOptions({createComponent:t=>new qo(t.id,e.components[t.name],{addPortal:s})})},[e.components]),t.useEffect(()=>{var t;if(!n.current)return;const i=null!==(t=e.headerComponents)&&void 0!==t?t:{};n.current.updateOptions({createHeaderComponent:e=>new qo(e.id,i[e.name],{addPortal:s})})},[e.headerComponents]),t.useEffect(()=>{if(!n.current)return()=>{};const t=n.current.onDidDrop(t=>{e.onDidDrop&&e.onDidDrop(t)});return()=>{t.dispose()}},[e.onDidDrop]),t.createElement("div",{style:{height:"100%",width:"100%"},ref:o},r)});Qo.displayName="PaneviewComponent",e.BaseGrid=me,e.ContentContainer=qe,e.DEFAULT_TAB_GROUP_COLORS=at,e.DefaultDockviewDeserialzier=Bt,e.DefaultTab=Ht,e.DockviewApi=we,e.DockviewComponent=$i,e.DockviewCompositeDisposable=h,e.DockviewDefaultTab=e=>{var{api:i,containerApi:o,params:n,hideClose:r,closeActionOverride:s,onPointerDown:a,onPointerUp:d,onPointerLeave:l,tabLocation:h}=e,p=function(e,t){var i={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&t.indexOf(o)<0&&(i[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var n=0;for(o=Object.getOwnPropertySymbols(e);n<o.length;n++)t.indexOf(o[n])<0&&Object.prototype.propertyIsEnumerable.call(e,o[n])&&(i[o[n]]=e[o[n]])}return i}(e,["api","containerApi","params","hideClose","closeActionOverride","onPointerDown","onPointerUp","onPointerLeave","tabLocation"]);const c=function(e){const[i,o]=t.useState(e.title);return t.useEffect(()=>{const t=e.onDidTitleChange(e=>{o(e.title)});return i!==e.title&&o(e.title),()=>{t.dispose()}},[e]),i}(i),v=t.useRef(!1),u=t.useCallback(e=>{e.preventDefault(),s?s():i.close()},[i,s]),g=t.useCallback(e=>{e.preventDefault()},[]),m=t.useCallback(e=>{v.current=1===e.button,null==a||a(e)},[a]),b=t.useCallback(e=>{v&&1===e.button&&!r&&(v.current=!1,u(e)),null==d||d(e)},[d,u,r]),f=t.useCallback(e=>{v.current=!1,null==l||l(e)},[l]);return t.createElement("div",Object.assign({"data-testid":"dockview-dv-default-tab"},p,{onPointerDown:m,onPointerUp:b,onPointerLeave:f,className:"dv-default-tab"}),t.createElement("span",{className:"dv-default-tab-content"},c),!r&&t.createElement("div",{className:"dv-default-tab-action",onPointerDown:g,onClick:u},t.createElement(Yo,null)))},e.DockviewDidDropEvent=Tt,e.DockviewEmitter=m,e.DockviewGroupPanel=Vt,e.DockviewGroupPanelModel=It,e.DockviewMutableDisposable=p,e.DockviewPanel=Wt,e.DockviewReact=jo,e.DockviewUnhandledDragOverEvent=yt,e.DockviewWillDropEvent=At,e.DockviewWillShowOverlayLocationEvent=ot,e.DraggablePaneviewPanel=Ze,e.Gridview=pe,e.GridviewApi=_e,e.GridviewComponent=Ui,e.GridviewPanel=Ot,e.GridviewReact=Ko,e.LiveRegionModule=Pi,e.PROPERTY_KEYS_DOCKVIEW=Ct,e.PROPERTY_KEYS_GRIDVIEW=ce,e.PROPERTY_KEYS_PANEVIEW=Fe,e.PROPERTY_KEYS_SPLITVIEW=Z,e.PaneFramework=Zi,e.PaneTransfer=s,e.PanelTransfer=r,e.Paneview=K,e.PaneviewApi=fe,e.PaneviewComponent=Ki,e.PaneviewPanel=Xe,e.PaneviewReact=Qo,e.PaneviewUnhandledDragOverEvent=Be,e.ReactPart=Oo,e.ReactPartContext=Eo,e.Splitview=X,e.SplitviewApi=be,e.SplitviewComponent=ji,e.SplitviewPanel=qi,e.SplitviewReact=Xo,e.Tab=it,e.TabGroupColorPalette=dt,e.applyTabGroupAccent=pt,e.clearRegisteredModules=function(){qt.length=0},e.createDockview=Qi,e.createGridview=to,e.createPaneview=io,e.createSplitview=eo,e.defineModule=Jt,e.directionToPosition=Ge,e.findRelativeZIndexParent=M,e.getDirectionOrientation=se,e.getGridLocation=ne,e.getLocationOrientation=ae,e.getPaneData=l,e.getPanelData=d,e.getRegisteredModules=ei,e.getRelativeLocation=re,e.indexInParent=oe,e.isDockviewPackageLoaded=oi,e.isGridBranchNode=le,e.isGroupOptionsWithGroup=Gt,e.isGroupOptionsWithPanel=zt,e.isPanelOptionsWithGroup=kt,e.isPanelOptionsWithPanel=St,e.isReactComponent=Lo,e.markDockviewPackageLoaded=ii,e.orthogonal=de,e.positionToDirection=Pe,e.registerModules=Qt,e.resolveMessages=Si,e.resolveTabGroupAccent=ct,e.themeAbyss=Rt,e.themeAbyssSpaced={name:"abyssSpaced",className:"dockview-theme-abyss-spaced",colorScheme:"dark",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeCatppuccinMocha={name:"catppuccinMocha",className:"dockview-theme-catppuccin-mocha",colorScheme:"dark"},e.themeCatppuccinMochaSpaced={name:"catppuccinMochaSpaced",className:"dockview-theme-catppuccin-mocha-spaced",colorScheme:"dark",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeDark={name:"dark",className:"dockview-theme-dark",colorScheme:"dark"},e.themeDracula={name:"dracula",className:"dockview-theme-dracula",colorScheme:"dark"},e.themeGithubDark={name:"githubDark",className:"dockview-theme-github-dark",colorScheme:"dark"},e.themeGithubDarkSpaced={name:"githubDarkSpaced",className:"dockview-theme-github-dark-spaced",colorScheme:"dark",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeGithubLight={name:"githubLight",className:"dockview-theme-github-light",colorScheme:"light"},e.themeGithubLightSpaced={name:"githubLightSpaced",className:"dockview-theme-github-light-spaced",colorScheme:"light",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeLight={name:"light",className:"dockview-theme-light",colorScheme:"light"},e.themeLightSpaced={name:"lightSpaced",className:"dockview-theme-light-spaced",colorScheme:"light",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeMonokai={name:"monokai",className:"dockview-theme-monokai",colorScheme:"dark"},e.themeNord={name:"nord",className:"dockview-theme-nord",colorScheme:"dark"},e.themeNordSpaced={name:"nordSpaced",className:"dockview-theme-nord-spaced",colorScheme:"dark",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeSolarizedLight={name:"solarizedLight",className:"dockview-theme-solarized-light",colorScheme:"light"},e.themeSolarizedLightSpaced={name:"solarizedLightSpaced",className:"dockview-theme-solarized-light-spaced",colorScheme:"light",gap:10,edgeGroupCollapsedSize:44,dndOverlayMounting:"absolute",dndPanelOverlay:"group",dndTabIndicator:"line",dndOverlayBorder:"2px solid var(--dv-active-sash-color)"},e.themeVisualStudio={name:"visualStudio",className:"dockview-theme-vs",colorScheme:"dark",edgeGroupCollapsedSize:22},e.toTarget=ge,e.usePortalsLifecycle=Mo,Object.defineProperty(e,"__esModule",{value:!0})});
